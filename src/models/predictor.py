...
_MODEL_FEATURES = [
    ...
    'TAIL_NUMBER', 'ORIGIN_AIRPORT', 'ORIGIN_STATE', 'DESTINATION_AIRPORT',
    'DEST_STATE', 'ROUTE', 'DISTANCE', 'SCHEDULED_TIME',
    'sched_dep_hour', 'sched_dep_minute', 'sched_dep_period',
    'sched_arr_hour', 'sched_arr_minute', 'sched_arr_period',
    'is_weekend', 'distance_bucket', 'day_of_year', 'doy_sin', 'doy_cos',
    'origin_day_hour_logvol', 'dest_day_hour_logvol',
    'te_airline_w7', 'te_airline_w30', 'te_origin_w7', 'te_origin_w30',
    'te_dest_w7', 'te_dest_w30', 'te_route_w7', 'te_route_w30',
    'te_origin_hour_w7', 'te_origin_hour_w30', 'te_origin_dow_w30',
    ...
    'origin_hour_dep_delay_mean_w30', 'route_dep_delay_mean_w30',
    'route_delayed_rate_w30',
]

# Cat feature indices: [4,6,7,8,9,10,11,16,19,21] → names for readability
_CAT_FEATURES = [
    'AIRLINE', 'TAIL_NUMBER', 'ORIGIN_AIRPORT', 'ORIGIN_STATE',
    'DESTINATION_AIRPORT', 'DEST_STATE', 'ROUTE',
    'sched_dep_period', 'sched_arr_period', 'distance_bucket',
]
...
def predict(params: FlightParams) -> PredictionResult:
    ...
    logger.info(
        ...
        params.origin, params.destination, params.airline, proba, threshold, proba >= threshold,
    )
